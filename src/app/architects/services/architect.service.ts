...
export class ArchitectService {
  ...
  private readonly architectsList: Architect[] = [
    {
      id: '1',
      path: 'levin',
      name: 'name',
  ...
  public fetchArchitects(): Architect[] {
    return this.architectsList;
  }

  public fetchArchitectByID(id: string): Architect {
    const architect = this.architectsList.filter(item => item.id === id);
